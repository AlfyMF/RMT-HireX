...
export function transformAPIResponseToFormData(apiData: any): Record<string, any> {
  ...
  return {
    ...
    expectedDateOfOnboardingStart: apiData.expectedDateOfOnboardingStart,
    expectedDateOfOnboardingEnd: apiData.expectedDateOfOnboardingEnd,
    idealStartDateStart: apiData.idealStartDateStart,
    idealStartDateEnd: apiData.idealStartDateEnd,
