...
export const createJobRequisitionSchema = z.object({
  ...
  expectedDateOfOnboardingStart: z.union([z.string().datetime(), z.date(), z.null()]).optional(),
  expectedDateOfOnboardingEnd: z.union([z.string().datetime(), z.date(), z.null()]).optional(),
  idealStartDateStart: z.union([z.string().datetime(), z.date(), z.null()]).optional(),
  idealStartDateEnd: z.union([z.string().datetime(), z.date(), z.null()]).optional(),
