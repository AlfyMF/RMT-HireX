...
async function main() {
  ...
  await prisma.workTimeZone.createMany({
    data: [
      { name: 'IST', description: 'Indian Standard Time', timezoneValue: 'Asia/Kolkata' },
      { name: 'EST', description: 'Eastern Standard Time', timezoneValue: 'America/New_York' },
      { name: 'PST', description: 'Pacific Standard Time', timezoneValue: 'America/Los_Angeles' },
      { name: 'GMT', description: 'Greenwich Mean Time', timezoneValue: 'Europe/London' },
      { name: 'CET', description: 'Central European Time', timezoneValue: 'Europe/Paris' },
      { name: 'JST', description: 'Japan Standard Time', timezoneValue: 'Asia/Tokyo' },
      { name: 'AEST', description: 'Australian Eastern Standard Time', timezoneValue: 'Australia/Sydney' },
    ],
    skipDuplicates: true,
  });
