...
async function main() {
  ...
  await prisma.skill.createMany({
    data: [
      ...
      { name: 'Angular', category: 'Frontend', isTechnical: true, importance: 'secondary' },
      { name: 'Vue.js', category: 'Frontend', isTechnical: true, importance: 'secondary' },
      { name: 'Django', category: 'Backend', isTechnical: true, importance: 'secondary' },
      { name: 'Flask', category: 'Backend', isTechnical: true, importance: 'secondary' },
      { name: 'Spring Boot', category: 'Backend', isTechnical: true, importance: 'secondary' },
    ],
    skipDuplicates: true,
  });
  ...
  if (engDept && hrDept && hiringManagerRole && duHeadRole && recruiterRole) {
    await prisma.user.createMany({
      data: [
        { name: 'John Doe', email: 'john.doe@example.com', role: 'Hiring Manager', roleId: hiringManagerRole.id, departmentId: engDept.id },
        { name: 'Jane Smith', email: 'jane.smith@example.com', role: 'DU Head', roleId: duHeadRole.id, departmentId: engDept.id },
        { name: 'Bob Johnson', email: 'bob.johnson@example.com', role: 'Hiring Manager', roleId: hiringManagerRole.id, departmentId: engDept.id },
        { name: 'Alice Williams', email: 'alice.williams@example.com', role: 'Recruiter', roleId: recruiterRole.id, departmentId: hrDept.id },
        { name: 'Charlie Brown', email: 'charlie.brown@example.com', role: 'DU Head', roleId: duHeadRole.id, departmentId: hrDept.id },
      ],
      skipDuplicates: true,
    });
  }
